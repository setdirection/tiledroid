...
public class OverlayManager extends AbstractList<Overlay> {
	...
	public void setWrapMap(boolean pWrapMap) {
		mTilesOverlay.setWrapMap(pWrapMap);
	}

	public boolean isWrapMap() {
		return mTilesOverlay.isWrapMap();
	}
	...
	public boolean onCreateOptionsMenu(final Menu pMenu, final int menuIdOffset,
		...
		if (mTilesOverlay instanceof IOverlayMenuProvider
				&& ((IOverlayMenuProvider) mTilesOverlay).isOptionsMenuEnabled()) {
			result &= ((IOverlayMenuProvider) mTilesOverlay).onCreateOptionsMenu(pMenu, menuIdOffset, mapView);
		}
	...
	public boolean onPrepareOptionsMenu(final Menu pMenu, final int menuIdOffset,
		...
		if (mTilesOverlay instanceof IOverlayMenuProvider
				&& ((IOverlayMenuProvider) mTilesOverlay).isOptionsMenuEnabled()) {
			((IOverlayMenuProvider) mTilesOverlay).onPrepareOptionsMenu(pMenu, menuIdOffset, mapView);
		}
